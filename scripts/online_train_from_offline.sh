...
#CKPT=/home/cfan/pytorch_segmentation/results/table_tennis1_off_seq0_spe/offline_distillation_dataset.max_frames=[1500,1300],dataset.sequence=table_tennis1,dataset.sequence_id=0,dataset.start_frame=[5000,12000],online_train.optimizer.lr=0.05,online_train.optimizer.momentum=0.99/epoch_29.pth.pth
#START_FRAME=0
#MAX_FRAMES=15000
...
#CKPT=/home/cfan/pytorch_segmentation/results/samui_walking_street1_off_seq0_clw_wt_sweep/8/epoch_29.pth.pth
START_FRAME=15000
MAX_FRAMES=3000
