...
CUDA_VISIBLE_DEVICES=$GPU python online_distillation.py \
    exp.id=${SEQ}_on_seq1_on_seq0_samples \
    ...
    online_train.resume_online=false \
    online_train.replay_samples=2 online_train.optimizer.lr=0.05 online_train.optimizer.momentum=0.9